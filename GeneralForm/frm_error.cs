...
namespace GeneralForm
{
    public partial class frm_error : Form
    {
        ...
        internal void SetInformation(Exception ex)
        {
            try
            {
                this.tx_message.Text = ex.Message;
            }
            catch { this.tx_message.Text = "UnKnow"; }
            try
            {
                this.tx_trace.Text = ex.StackTrace;

            }
            catch
            {
                this.tx_trace.Text = "UnKnow";
            }
        }
