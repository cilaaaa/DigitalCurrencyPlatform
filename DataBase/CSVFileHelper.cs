...
namespace DataBase
{
    public class CSVFileHelper
    {
        ...
        public static void SaveCSV(DataTable dt, string fullPath)
        {
            ...
            {
                System.Diagnostics.Process.Start("explorer.exe", "E:\\Bitcoin\\test");
            }
        }
        ...
        //public static DataTable OpenCSV(string path)
        //{
        ...
        //        string connString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + filePath.Remove(filePath.LastIndexOf("\\") + 1).TrimEnd('\\') + ";Extended Properties='Text;FMT=Delimited;HDR=YES;'";
        ...
        //            strExcel = "Select   *   From   [" + tableName + "] Where symbol = 'XBTUSD'";
